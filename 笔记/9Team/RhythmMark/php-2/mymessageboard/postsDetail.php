...
if(!empty($_REQUEST['id']))
{
	...
	{
		global $connect;   //在函数内引用变量connect
		$userInfo = [];
		// 关联出来发布的用户信息
	...
	<div class="postsInfo">
		...
		<div class="postsDetail">
			...
			<div class="content">
				...
				<a href="<?php  echo "changetc.php?id=".$_REQUEST['id']."&&author=".$postsDetail['userInfo']['name']?>">修改</a>
			</div>
			<div class="pictures">
				<?php 
				...
				<?php foreach ($postsDetail['commentList'] as $key => $value): ?>
					<div class="comment-item">
						...
						<div class="commentList-content">
							...
							<a href="<?php  echo "changecm.php?tpid=".$_REQUEST['id']."&&id=".$value['id']."&&author=".$value['userInfo']['name']?>">修改</a>
							<a href="<?php  echo "deletecm.php?tpid=".$_REQUEST['id']."&&id=".$value['id']."&&author=".$value['userInfo']['name']?>">删除</a>
						</div>
					</div>
				<?php endforeach ?>
			</div>
